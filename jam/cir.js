define(["util", "../lib/sylvester"], function(Util, Syl) {
  // Ideally msot of this can go in a shared file, and we just punch out the geometry specific bits,
  // but for now I'm just going to copy and paste rect.
	var self = {};
	...
	self.overlap = function(s1, s2, callback){
		...
		for(var i = 0; i < g1.length; ++i) {
			for(var j = 0; j < g2.length; ++j) {
              ...
              // Not going to mess with collison offsets or anything for now.
              // Assume things going thorugh this have a radius.
                ...
                var cdist = g1[i].radius + g2[j].radius;
